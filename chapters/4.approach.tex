...
\texttt{qwen2.5:\allowbreak 7b}, none of which is what the platform actually
runs: the model deployed is \texttt{qwen2.5:\allowbreak 3b}, smaller than any
of them. None of the larger candidates was actually benchmarked on the
