...
\def\reportTitle{Cyber Crisis Management Maturity Self-Assessment Platform} % Titre du mémoire
\def\reportLongTitle{Operationalising the ENISA Best Practices for Cyber Crisis Management into a Deterministic, Locally AI-Augmented Assessment Tool} % Titre plus long du mémoire

\def\reportAuthor{Arthur Saunier} % Nom et prénom de l'élève
\def\reportAuthorEmail{\email{arthur.saunier@telecomnancy.eu}} % Courriel de l'élève

% Signatures
\addSignaturesLine{{
  {figures/signature-arthur}{Arthur SAUNIER}{Élève-ingénieur},
  {figures/blank}{Riccardo Bergamaschi}{Internship supervisor}
}}
...
\def\reportAuthorAddress{5, rue Sainte-Elisabeth} % Adresse de l'élève
\def\reportAuthorCity{57100, THIONVILLE} % Adresse (cont.) de l'élève
\def\reportAuthorPhone{+33 651817521} % Téléphone de l'élève

%\def\reportIndustrialSupervisor{Eddard Stark} % Prénom Nom de l'encadrant industriel
\def\reportSupervisor{Riccardo Bergamaschi} % Prénom Nom de l'encadrant industriel (en entreprise ou laboratoire)
\def\reportAcademicSupervisor{Christophe Bianco} % Prénom Nom de l'encadrant académique
...
\def\reportCompany{Wavestone Luxembourg} % Nom de l'entreprise d'accueil
\def\reportCompanyAddress{12, rue du Château d'Eau}  % Adresse de l'entreprise
\def\reportCompanyCity{3364, LEUDELANGE, LUXEMBOURG} % Adresse (cont.) de l'entreprise
\def\reportCompanyPhone{+352 2637741} % Téléphone de l'entreprise
\def\reportCompanyLogoPath{figures/wavestone-logo} % Logo de l'entreprise -- comment this definition to remove company logo
%\def\reportSecondCompanyLogoPath{figures/logo.png} % Deuxième logo d'entreprise si besoin

\def\place{Thionville} % Ville pour la signature pour l'engagement anti-plagiat
\def\date{31 août 2026} % Date pour la signature de l'engagement anti-plagiat

% =============================================================
% Glossaire / liste des acronymes
% =============================================================

% -- Cadre reglementaire et referentiels
\newacronym{EU}{EU}{European Union}
\newacronym{ENISA}{ENISA}{European Union Agency for Cybersecurity}
\newacronym{NIS2}{NIS2}{Directive (EU) 2022/2555 on measures for a high common level of cybersecurity across the Union}
\newacronym{CyCLONe}{CyCLONe}{EU Cyber Crisis Liaison Organisation Network}
...
\newacronym{ISACA}{ISACA}{Information Systems Audit and Control Association}
\newacronym{CISA}{CISA}{Cybersecurity and Infrastructure Security Agency}
\newacronym{FFIEC}{FFIEC}{Federal Financial Institutions Examination Council}
\newacronym{OWASP}{OWASP}{Open Worldwide Application Security Project}

% -- Vocabulaire du projet
\newacronym{PFE}{PFE}{Projet de Fin d'\'Etudes}
\newacronym{BP}{BP}{best practice, as numbered BP01 to BP16 in the referential}
\newacronym{MVP}{MVP}{minimum viable product}
\newacronym{BCP}{BCP}{Business Continuity Plan}
\newacronym{BRP}{BRP}{Business Recovery Plan}
...
\renewcommand{\lstlistlistingname}{Code Listings}   % pas un nom babel : renewcommand nu
...
\insertAntiPlagiarismAgreement{Saunier, Arthur}{32317052}{figures/signature-arthur}{0.3}
...
Je tiens à remercier en premier lieu Riccardo Bergamaschi, mon encadrant industriel,
pour l'autonomie qu'il m'a accordée tout au long de ce projet, sa disponibilité
et la confiance qu'il m'a témoignée dans la conduite des choix techniques comme
méthodologiques.

Je remercie également Jérôme de Lisle, à la tête de la practice Cyber de Wavestone
Luxembourg, pour sa confiance et son accompagnement durant l'ensemble du stage.

Mes remerciements vont aussi à Anna Chevalier, dont l'intérêt pour les
exercices de gestion de crise et les retours qu'elle m'a apportés ont nourri
utilement ce travail.

Je remercie enfin Christophe Bianco, mon tuteur académique à TELECOM Nancy, pour
sa disponibilité, son suivi régulier et ses conseils tout au long de ce projet de
fin d'études.
...
\input{chapters/A.reference_tables.tex}
\cleardoublepage{}

\input{chapters/B.supporting_figures.tex}
