...
\def\reportCompany{Wavestone Luxembourg} % Nom de l'entreprise d'accueil12 Rue du Chateau d'Eau, 3364 Leudelange
\def\reportCompanyAddress{12, rue du Chateau d'Eau}  % Adresse de l'entreprise
\def\reportCompanyCity{c3364, LEUDELANGE, LUXEMBOURG} % Adresse (cont.) de l'entreprise
